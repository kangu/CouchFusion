...
Implementation Summary: Updated the new and create_layer workflows to derive their workspace root from the caller's current working directory, ensuring apps and layers are discovered relative to where the CLI is executed.
