# Contributing to CouchFusion

This document describes the process of contributing to CouchFusion. It is intended
...
> appreciate your contributions. CouchFusion is a personal project for me that
...
> [!IMPORTANT]
>
> If you are using **any kind of AI assistance** to contribute to CouchFusion,
> it must be disclosed in the pull request.

If you are using any kind of AI assistance while contributing to CouchFusion,
**this must be disclosed in the pull request**, along with the extent to
which AI assistance was used (e.g. docs only vs. code generation, include the full transcript of
the discussion and the planning with the LLM agent).
...
["contributor friendly"]: https://github.com/kangu/CouchFusion/issues?q=is%3Aissue%20is%3Aopen%20label%3A%22contributor%20friendly%22

### I'd like to translate CouchFusion to my language

We will be writing a [Translator's Guide](README_TRANSLATORS.md) for
everyone interested in contributing translations to CouchFusion.
...
[closed issues]: https://github.com/kangu/CouchFusion/issues?q=is%3Aissue%20state%3Aclosed
[discussions]: https://github.com/kangu/CouchFusion/discussions?discussions_q=is%3Aclosed
["Issue Triage" discussion]: https://github.com/kangu/CouchFusion/discussions/new?category=issue-triage

### I have an idea for a feature

Open a discussion in the ["Feature Requests, Ideas" category](https://github.com/kangu/CouchFusion/discussions/new?category=feature-requests-ideas).
...
[Q&A discussion]: https://github.com/kangu/CouchFusion/discussions/new?category=q-a

## General Patterns

### Issues are Actionable

The CouchFusion [issue tracker](https://github.com/kangu/CouchFusion/issues)
is for _actionable items_.

Unlike some other projects, CouchFusion **does not use the issue tracker for
discussion or feature requests**. Instead, we use GitHub
[discussions](https://github.com/kangu/CouchFusion/discussions) for that.
